...
import ethos.model.npcs.bosses.zulrah.impl.MageStageThree;
	...
	public void processPacket(final Player c, int packetType, int packetSize) {
		...
		case FIRST_CLICK:
			...
			case 11701:
				...
				break;
			case 9398:// deposit
				c.getPA().sendFrame126("The Bank of Special-PKz - Deposit Box", 7421);
			...
			case 6551://raids 2 teleport home
				c.getPA().startTeleport(2911, 5087, 0, "modern", false);
				c.sendMessage("Collect the keys to pass through the game.");
				break;
				
			case 23707:// room2 raids 2
				if (c.getItems().playerHasItem(6754)) {
					c.getItems().deleteItem(6754, 1);
					c.sendMessage("you use the key to move to the last room.");
					c.getPA().startTeleport(3023, 5341, 8, "modern", false);
				} else {
					c.sendMessage("You need a enchanted key to unlock the last room.");
				}
				break;
				
			case 14892:// room1 raids 2
				if (c.getItems().playerHasItem(3741)) {
					c.getItems().deleteItem(3741, 1);
					c.sendMessage("you use the frozen key to move to the next room.");
					c.getPA().startTeleport(3023, 5341, 0, "modern", false);
				} else {
					c.sendMessage("You need a frozen key to unlock the next room.");
				}
				break;
				
			case 13291://raids 2 magic box
				if (c.getItems().playerHasItem(20608)) {
					c.getItems().deleteItem(20608, 1);
					c.startAnimation(881);
					c.getItems().addItem(22325, 1);
					c.getItems().addItem(22323, 1);
					c.getItems().addItem(22324, 1);
					c.sendMessage("@blu@You stick your hand in the chest and pull some items out.");
				} else {
			...
			case 3264:// wellofgoodwill
				c.getPA().showInterface(38000);
				break;
			case 31681:// Unlocks top floor dusk and dawn
				if (c.getItems().playerHasItem(21724)) {
					c.getItems().deleteItem(21724, 1);
					c.sendMessage("you use the key to open the higher floor.");
					c.getPA().startTeleport(1703, 4575, 0, "modern", false);
				} else {
					c.sendMessage("You need a key to unlock thease stairs.");
				}
				break;
			case 11835:// the Inadequacy
				c.getPA().startTeleport(1822, 5166, 2, "modern", false);
				c.sendMessage("You have been teleported to the Inadequacy.");
				break;
			case 2804:// plasmaroom - dungeon
				c.getPA().startTeleport(3683, 9888, 0, "modern", false);
				c.sendMessage("You have been teleported to the plasma room.");
				break;
			case 16108:// plasma room exit 
				c.getPA().movePlayer(2457, 2849, 0);
				c.sendMessage("You have left the plasma room.");
				break;
			case 7475:// portal of vespula gates 
				c.getPA().movePlayer(3265, 2784, 0);
				c.sendMessage("You have passed through the gates using the portal.");
				break;
			case 20341:// gates of vespula 
				c.getPA().movePlayer(3264, 2785, 0);
				c.sendMessage("You have passed through the gates to Vespula, use the portal to get back.");
				break;
			case 31621:// portal of heros - tekton
				c.getPA().startTeleport(3710, 3968, 0, "modern", false);
				c.sendMessage("You have been teleported to the Heroic tekton.");
				break;
			case 31618:// portal of champions - muttadile
				c.getPA().startTeleport(2595, 3910, 0, "modern", false);
				c.sendMessage("You have been teleported to the champion muttadile.");
				break;
			case 31622:// Portal of legends - Unknown
				c.sendMessage("Coming soon...");
				break;
			case 28686:// vespula
				c.getPA().startTeleport(3271, 2784, 0, "modern", false);
				c.sendMessage("You have been teleported to the Powerful Vespula.");
				break;
			case 31624://new altar at legzone - C.T
				c.specRestore = 120;
				c.specAmount = 10.0;
				c.setRunEnergy(100);
				...
				c.nextChat =  -1;
				break;
			case 31627:// legzone stairs creator C.T
				c.getPA().movePlayer(2456, 2839, 1);
				c.sendMessage("You have been sent up the legendary stairs.");
				break;
			case 31609:// legzone stairs creator C.T
				c.getPA().movePlayer(2450, 2848, 2);
				c.sendMessage("Welcome to the highest level of the legendary donation zone.");
				break;
			case 31611:// legzone stairs creator C.T
				c.getPA().movePlayer(2447, 2858, 1);
				c.sendMessage("You have been pulled up the stairs.");
				break;
			case 31612:// legzone stairs creator C.T
				c.getPA().movePlayer(2447, 2858, 2);
				c.sendMessage("You have been pulled up to the top.");
				break;
			case 31616:// legzone mistycal barrier creator C.T
				c.getPA().movePlayer(2457, 2863, 0);
				c.sendMessage("If you use this barrier, only way back is to use the legzone teleport.");
				break;
			case 31626:// legzone dungeon statue teleport
				c.getPA().startTeleport(2518, 3046, 0, "modern", false);
				c.sendMessage("You have been teleported to the Legendary boss zone.");
				break;
			case 27785:
			...
			case 26709:// strongholdslayer cave
				...
				break;
			case 19039:// Giant scarab
				c.objectDistance = 3;
				break;
			case 23096:// skilling zone
				c.getPA().movePlayer(1803, 3787, 0);
				c.sendMessage("Welcome to the secret skilling zone!");
				break;
			case 23676: // Teleportation interface C.T
