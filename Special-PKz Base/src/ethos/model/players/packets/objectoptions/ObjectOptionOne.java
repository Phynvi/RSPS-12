...
public class ObjectOptionOne {
	...
	public static void handleOption(final Player c, int objectType, int obX, int obY) {
		...
		NylocasVasilias NylocasVasilias;
		switch (objectType) {
		...
		case 29735:
			if (c.objectX != 3277 && c.objectY != 5169) {
				...
				AgilityHandler.delayEmote(c, "CLIMB_DOWN_EMOTE", 2634, 5069, 0, 2);
				c.sendMessage("Welcome to the Basic training dungeon, you can find basic monsters here!");
			}
			break;
		case 19039:
			c.startAnimation(844);
			AgilityHandler.delayEmote(c, "CRAWL_EMOTE", 2916, 3625, 0, 2);
			c.sendMessage("Welcome to the Giant scarab!");
			break;
		 ...
		 */
			case 8720:
				...
				c.sendMessage("@red@ Please visit our site to vote, And to claim ::claimvote 1 all to receive them!");
				c.sendMessage("@red@ Thank you for supporting Special-PKz!");
				break;
			case 31556:
		...
		case 15638:
		case 7479:
			c.getPA().startTeleport(3279, 3498, 0, "modern", false);
			break;
		case 11803:
		...
		case 27362:// lizardmen
			if (c.absY > 3688) {
				...
				c.sendMessage("You climb down into Danger Assault.");
			} else
