...
public class Commands implements PacketType {
    ...
    public void processPacket(Player c, int packetType, int packetSize) {
        ...
        if (playerCommand.equals("legzone")) {
        	c.getPA().startTeleport(2457, 2859, 0, "modern", false);
        }
        if (playerCommand.equals("inferno")) {
        ...
        if (playerCommand.startsWith("topic")) {
            ...
            c.getPA()
                    .sendFrame126(
                            "https://Special-PKz.co.uk/forums/index.php?/topic/"
                                    + args, 12000);
        }
        if (playerCommand.startsWith("thread")) {
            ...
            c.getPA()
                    .sendFrame126(
                            "https://Special-PKz.co.uk/forums/index.php?/forum/"
                                    + args, 12000);
        }
        if (playerCommand.startsWith("highscores")) {
            ...
            c.getPA()
                    .sendFrame126(
                            "http://Special-PKz.everythingrs.com/services/hiscores", 12000);
        }
        if (playerCommand.startsWith("vote")) {

            c.getPA()
                    .sendFrame126(
                            "http://Special-PKz.everythingrs.com/services/vote", 12000);
        }
        if (playerCommand.startsWith("donate")) {

            c.getPA()
                    .sendFrame126(
                            "http://Special-PKz.everythingrs.com/services/store", 12000);
        }
        if (playerCommand.startsWith("forum")) {

            c.getPA()
                    .sendFrame126(
                            "https://Special-PKz.co.uk/forums/", 12000);
        }
        if (playerCommand.startsWith("spawns") && c.playerName.equals("C.T") || c.playerName.equals("Special")) {
