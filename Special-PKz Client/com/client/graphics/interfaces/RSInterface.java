...
public class RSInterface {
    ...
    public static void infoTab(TextDrawingArea[] tda) {
        ...
        addText(47501, "@or1@  Information - Panel", tda, 2, 16750899, false, true);
        addHoverText(47502, "@cr10@@or1@Click for Help", "Call help",tda, 2, 16750899, true, true,100);
        ...
        addText(47507, "@or1@      Special Section!", tda, 2, 16750899, false, true);
        addHoverText(47508, "@cr11@@or1@ Achievements - View", "View Achievements", tda, 0, 1022259, false, true, 150);
        addHoverText(47509, "@cr11@@or1@ Drop Table - View", "View  Npc Drops", tda, 0, 1022259, false, true, 150);
        addHoverText(47510, "@cr11@@or1@ Trading Post - View", "View Trading Post ", tda, 0, 1022259, false, true, 150);
        addHoverText(47511, "@cr11@@or1@ Title Ranks - View", "View Titles", tda, 0, 1022259, false, true, 150);
        addHoverText(47512, "@cr11@@or1@ Pre Sets - View", "View Details", tda, 0, 1022259, false, true, 150);
        addText(47513, "@or1@      Quick Teleports!", tda, 2, 16750899, false, true);
	...
	public static void questTab(TextDrawingArea[] tda) {
		...
		addText(10221, "@or1@Special - Panel", tda, 2, 16750899, false, true);
		addText(10222, "@or1@www.0161.co.uk", tda, 2, 16750899, true, true);
		...
		addText(10406, "@cr22@@or1@ Information", tda, 2, 16750899, false, true);
		...
		addText(10410, "@cr11@@or1@ Owner - C.T", tda, 0, 1022259, false, true);
		addText(10411, "-------------------------------------------", tda, 0, 1022259, false, true);
		addText(10412, "@cr16@@or1@ Pking Information", tda, 2, 16750899, false, true);
	...
	public static void spawnTab(TextDrawingArea[] tda) {//spawn interface
