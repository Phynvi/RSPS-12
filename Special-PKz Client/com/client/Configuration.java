...
public class Configuration {
	...
	public static final String CLIENT_TITLE = "CamelScape";
	...
	public static final String CACHE_NAME = "Special-PKz_.32";

	public static boolean repackIndexOne = false, repackIndexTwo = false, repackIndexThree = false,
			repackIndexFour = false;

	public static final String CACHE_LINK = "https://www.dropbox.com/s/ztwarrsu9cvx8dp/Special-PKz_.32.zip?dl=1"; // Link for every client below client
	...
	public static final String SPRITE_CACHE_URL = "https://dl.dropbox.com/s/rmmkfkgo55ny7fh/sprites.zip"; // Link for every client below
																						// client v1.12 - being
	public static final String VERSION_URL = "https://dl.dropbox.com/s/qcbz5f0ruyzdqn8/version.txt";
